            ...
            <div className='row align-item-center' style={{ height: "88%" }}>
                ...
                <div className='col-md-6 d-flex align-items-center justify-content-center'>
                    <div className='text-center'>
                        ...
                        <a className='invoice_login_button' href={'https://accounts.zoho.in/oauth/v2/auth?client_id=1000.BT9I3S8CS2QD7GEXT4AIROGM09VPBS&response_type=token&scope=ZohoInvoice.invoices.CREATE,ZohoInvoice.invoices.UPDATE,ZohoInvoice.invoices.READ,ZohoInvoice.invoices.DELETE,ZohoInvoice.contacts.READ,ZohoInvoice.contacts.CREATE&redirect_uri=http://localhost:3000/auth.html'}>Login</a>
