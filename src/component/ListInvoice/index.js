...
function LISTPAGE() {
  ...
  return (<div class='row'>
    ...
    <div className='row p-5'>
      ...
      <div className='col-md-6 row align-item-center justify-content-center '>
        <div className='text-center'><Link to="/createinvoice">Home</Link></div>
      </div>
    </div>
          ...
          <Column width={120} fixed="right">
            ...
            <Cell>
              {rowData => {
                ...
                return (
                  <span>
                   <Link to={`/editInvoice/${rowData.invoice_id}`}>Edit</Link> | <a onClick={handleAction}> Remove </a>
                  </span>
                );
              }}
            </Cell>
